@component('admin.layouts.content' , ['title' => 'ویرایش برند'])
    @slot('breadcrumb')
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.users.index') }}">لیست برند ها</a></li>
                ...
                <form class="form-horizontal" action="{{ route('admin.brands.update' , $brand->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" id="inputEmail3" placeholder="نام برند را وارد کنید" value="{{ old('title' , $brand->title) }}">
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                ...
                                <div class="col form-check">
                                    <input type="url" name="url" id="url" class="form-control" value="{{ old('url' , $brand->url) }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="seo_description" class="form-label required">توضیحات سئو</label>
                                <div class="form-check">
                                    <textarea name="seo_description" id="seo_description" cols="200" rows="3" class="form-control">{{ old('seo_description' , $brand->seo_description) }}</textarea>
                                </div>
                            </div>
                            <div class="form-group col">
                                ...
                                <div id="seo_status" class="form-check form-check-inline">
                                    <input {{ old('seo_status', $brand->seo_status) == 'Index' ? 'checked' :''}} class="form-check-input" type="radio" id="Index" name="seo_status" value="Index">
                                    <label for="Index" class="form-check-label">
                                        Index, follow
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input {{ old('seo_status', $brand->seo_status) == 'NoIndex' ? 'checked' :''}} class="form-check-input" type="radio" id="NoIndex" name="seo_status" value="NoIndex">
                                    <label for="NoIndex" class="form-check-label">
                                        No Index, no follow
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input {{ old('seo_status', $brand->seo_status) == 'Default' ? 'checked' :''}} class="form-check-input" type="radio" id="Default" name="seo_status" value="Default">
                    ...
                    <div class="col-4">
                        <div class="form-group col">
                            ...
                            <img src="{{$brand->image?? ''}}" width="100%" alt="" id="image">
                        ...
                        <div class="form-group col">
                            ...
                            <div id="status" class="form-check form-check-inline">
                                <input {{ old('status', $brand->status) == 1 ? 'checked' :''}} class="form-check-input" type="radio" id="Public" name="status" value="1">
                                <label for="Public" class="form-check-label">
                                    فعال
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input {{ old('status', $brand->status) == 0 ? 'checked' :''}} class="form-check-input" type="radio" id="Draft" name="status" value="0">
                        ...
                        <div class="">
                            <button type="submit" class="btn btn-info">ویرایش برند</button>
