@component('admin.layouts.content' , ['title' => 'ایجاد تگ'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="/admin">پنل مدیریت</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.users.index') }}">لیست تگها ها</a></li>
                ...
                <form class="form-horizontal" action="{{ route('admin.tags.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-8">
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">نام تگ

                            </label>
                            <input type="text" name="title" class="form-control" id="inputEmail3" placeholder="نام تگ را وارد کنید">
                        </div>
                    ...
                    <div class="col-4">
                        ...
                        <div class="form-group col">
                            ...
                            <label for="status" class="form-label required">وضعیت تگ</label>
                        ...
                        <div class="">
                            <button type="submit" class="btn btn-info">ثبت تگ</button>
