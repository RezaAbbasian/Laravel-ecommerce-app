@component('admin.layouts.content' , ['title' => 'ایجاد برند'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="/admin">پنل مدیریت</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.users.index') }}">لیست برندها ها</a></li>
                ...
                <form class="form-horizontal" action="{{ route('admin.brands.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" id="inputEmail3" placeholder="نام برندرا وارد کنید">
                        </div>
                    ...
                    <div class="col-4">
                        ...
                        <div class="form-group col">
                            ...
                            <label for="status" class="form-label required">وضعیت برند</label>
                        ...
                        <div class=" ">
                            <button type="submit" class="btn btn-info">ثبت برند</button>
